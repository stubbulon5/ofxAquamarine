...
{
    class uiVizWidgetElmCheckbox : public uiVizWidgetElm
    {

    public:
        uiVizWidgetElmCheckbox(string persistentId, string widgetXML, uiVizWidgetBase *parent) : uiVizWidgetElm(persistentId, widgetXML, parent)
        {
            initWidget();
            loadState(widgetXML);
        }
        ...
        virtual ~uiVizWidgetElmCheckbox()
        {
        }
