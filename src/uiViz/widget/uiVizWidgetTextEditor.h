...
// #ifdef VIZ_DISABLE_GLEDITOR
    ...
    class uiVizWidgetTextEditor : public uiVizWidget
    {
    public:
        uiVizWidgetTextEditor(string persistentId, string widgetXML) : uiVizWidget(persistentId, widgetXML) {}
...
//     class uiVizWidgetTextEditor : public uiVizWidget, public ofxGLEditorListener
//     {
//     public:
//         uiVizWidgetTextEditor(string persistentId, string widgetXML) : uiVizWidget(persistentId, widgetXML)
//         {
...
//             settings.setAttribute("widget", "class", uiVizWidgetManager::WIDGET_CLASS_TEXT_EDITOR, 0);
...
//                 mLoadedFile = path;
//                 if (transmitEvent)
//                     eventTransmit(getPersistentId(), WIDGET_EVENT::SAVED, "<event>" + uiVizShared::encodeForXML(mLoadedFile) + "</event>", *this);
//             }
//             return saved;
//         }
