...
{
    class uiVizWidgetMediaPlayerBase : public uiVizWidget
    {
    public:
        uiVizWidgetMediaPlayerBase(string persistentId, string widgetXML) : uiVizWidget(persistentId, widgetXML)
        {
            initWidget();
            loadState(widgetXML);
        }
        ...
        virtual ofxXmlSettings saveState() override
        {
            ...
            settings.setAttribute("widget", "class", "uiVizWidgetMediaPlayerBase", 0);
        ...
        virtual ~uiVizWidgetMediaPlayerBase() {
        };
    ...
    private:
        ...
        void initWidget() override
        {
            ...
            play_pause = dynamic_cast<uiVizWidgetElmButton *>(addOrLoadWidgetElement(play_pause, WIDGET_ELM_CLASS::BUTTON, "PLAY_PAUSE", R"(
            <element>
            ...
            scrubber = dynamic_cast<uiVizWidgetElmSlider *>(addOrLoadWidgetElement(scrubber, WIDGET_ELM_CLASS::SLIDER, "SCRUBBER", R"(
            <element>
