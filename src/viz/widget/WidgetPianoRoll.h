...
{
    class WidgetPianoRoll : public WidgetSequencerBase
    {
    public:
        WidgetPianoRoll(string persistentId, string widgetXML) : WidgetSequencerBase(persistentId, widgetXML)
        {
            initWidget();
            loadState(widgetXML);
        }
        ...
        virtual bool loadState(string widgetXML) override
        {
            ...
            setHeaderRow(WidgetTableRow("PIANO_KEY", headerCells));
            ...
            for (int keys = 0; keys <= 87; keys++)
            {
                ...
                WidgetTableRow row = WidgetTableRow(keyNote, {WidgetTableCell(keyNote + ofToString(octave), keyNote + ofToString(octave))});
        ...
        virtual ofxXmlSettings saveState() override
        {
            ...
            settings.setAttribute("widget", "class", WidgetManager::WIDGET_CLASS_PIANO_ROLL, 0);
        ...
        {
            WidgetSequencerBase::drawCellContent(isRowSelected, isRowHovered, isCellHovered, absoluteScaledX, absoluteScaledY, absoluteScaledLabelX, absoluteScaledLabelY, scaledWidth, scaledHeight, row, cell, rowIndex, colIndex);
        }
        ...
        virtual void afterRowsDrawn()
        {
            ...
            Elm vizElm_cell;
            Coord::vizBounds headerColBounds = getHeaderColBounds();
